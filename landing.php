    ...
    <section class="section" id="tentang">
      <div class="stats">
        <div class="stat">
          ...
          <div class="lbl">Peran akses berbeda</div>
        </div>
        <div class="num-wrap stat">
          <div class="num mono">5</div>
          <div class="lbl">Kategori permohonan</div>
        </div>
        <div class="stat">
          <div class="num mono">92%</div>
          <div class="lbl">Rata-rata SLA terpenuhi</div>
        </div>
        <div class="stat">
          <div class="num mono">1</div>
          <div class="lbl">Antrian, tanpa duplikasi</div>
        </div>
      </div>

      <div class="section-head" style="margin-top:56px;">
        <span class="eyebrow">Tim Pengembang</span>
        <h2>Anggota Kelompok.</h2>
        <p>Klik salah satu nama untuk melihat tugas individu masing-masing anggota.</p>
      </div>
      <div class="team">
        <?php foreach ($anggotaKelompok as $a): ?>
          <a href="<?= htmlspecialchars($a['link']) ?>" target="_blank" class="team-card">
            <div class="team-avatar"><i class="bi bi-person-fill"></i></div>
            <h4><?= htmlspecialchars($a['nama']) ?></h4>
            <span><?= htmlspecialchars($a['npm']) ?></span>
          </a>
        <?php endforeach; ?>
      </div>
